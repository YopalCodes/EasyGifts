...
public class ConTitlePrompt extends StringPrompt {
    @Override
    public String getPromptText(ConversationContext conversationContext) {
        return PlayerInteract.returnPrefix() + "Type a message to make a title! Use & for chat color. Type \"cancel\" to cancel making the title!";
    }
